...
local function reset(device, jbeamData)
  ...
  --#region addition from EV

  device.friction = jbeamData.friction or 0

  device.outputAV1 = 0
  --device.inputAV = 0 dupe
  ...
  device.syntheticGearRatio = jbeamData.evGearRatio or 1
  device.outputTorqueState = 1
...
local function new(jbeamData)
  local device = {
    ...
    unSmoothed = jbeamData.unSmoothed or false,
    ...
    syntheticGearRatio = jbeamData.evGearRatio or 1,
